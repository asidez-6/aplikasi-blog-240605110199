...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('penulis.index') }}" class="btn btn-sm"
       style="background-color:#f0f0f0;color:#555;">Kembali</a>
</div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('penulis.update', $penulis->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="mb-2">
                    <img src="{{ asset('storage/foto/' . $penulis->foto) }}" alt="Foto"
                ...
                <div class="form-text" style="font-size:12px;">Format: JPG, JPEG, PNG. Maks 2 MB. Kosongkan jika tidak ingin mengubah.</div>
                @error('foto')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="d-flex gap-2 justify-content-end">
                <a href="{{ route('penulis.index') }}" class="btn btn-sm"
                   style="background-color:#f0f0f0;color:#555;">Batal</a>
